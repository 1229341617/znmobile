<template>
  ...
  <div style="overflow: hidden">
    ...
    <ul class="entering">
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">合计金额：</span>
          <span class="entering-input">{{total}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">手机：</span>
          <span class="entering-input">{{mobile}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">报销单位：</span>
          <span class="entering-input">{{pk_org}}</span>
        </div>
      </li>
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">单位银行账户：</span>
          <span class="entering-input">{{fkyhzh}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">项目：</span>
          <span class="entering-input">{{project_name}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">供应商：</span>
          <span class="entering-input">{{hbbm}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">收款对象：</span>
          <span class="entering-input">{{paytarget}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">客商银行账户：</span>
          <span class="entering-input">{{custaccount}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">事由：</span>
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">汽车档案:</span>
              <span class="entering-input">{{item.defitem10}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              ...
              <span class="entering-input">{{item.defitem1}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">增值税税率:</span>
              <span class="entering-input">{{item.defitem6}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">税金:</span>
              <span class="entering-input">{{item.tax_amount}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
              <span class="entering-title">税率:</span>
              <span class="entering-input">{{item.tax_rate}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">报销金额:</span>
              <span class="entering-input">{{item.vat_amount}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">不含税金额:</span>
              <span class="entering-input">{{item.tni_amount}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">发票号码:</span>
              <span class="entering-input">{{item.fphm}}</span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="panelBody" v-for="(item,index3) in hotelList"  v-show="'show'+index$2 === isOpen2">
        <ul class="entering">
          ...
          <li class="entering-itemsub" @click="selectStage">
            <div class="entering-left">
              <span class="entering-title">入住日期:</span>
              <span class="entering-input">{{item.defitem1}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">离店日期:</span>
              <span class="entering-input">{{item.defitem2}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">住宿天数:</span>
              <span class="entering-input">{{item.defitem9}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
    ...
    <div class="panel"  >
      <div class="panelTitle" @click="openProject3(index$3)">
        <div class="titleLeft">出差补贴</div>
        <div class="titleRight">
          <img src="./image/icon_close.svg" v-show="'show'+index$3 === isOpen3"/>
          <img src="./image/icon_open.svg" v-show="'show'+index$3 != isOpen3"/>
        </div>
      </div>
      <div class="panelBody"  v-for="(item,index4) in travelList" v-show="'show'+index$3 === isOpen3" >
        <ul class="entering">
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">出差补差标准:</span>
              <span class="entering-input">{{item.defitem11}}</span>
            </div>
          </li>
          <li class="entering-itemsub" @click="selectStage">
            <div class="entering-left">
    ...
    <div class="panel"  >
      ...
      <div class="panelBody"  v-for="(item,index5) in writeoffList" v-show="'show'+index$4 === isOpen4">
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">费用原币金额:</span>
              <span class="entering-input">{{item.fyybje}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
  ...
  export default {
    ...
    methods:{
      ...
      openProject2(index) {
        ...
        if(!this.hotelList[0] && this.isOpen2!="hidden"){
      ...
      openProject3(index) {
        ...
        if(!this.travelList[0] && this.isOpen3!="hidden"){
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          ...
          if (res.flag === "success"){
            //console.log(res);
            that.publicBusData = res.billdata;
            if(that.publicBusData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            that.djbh = res.billdata.djbh;
            that.djrq = res.billdata.djrq;
            that.total = res.billdata.total;
            that.skyhzh = res.billdata.skyhzh;
            that.jkbxr = res.billdata.jkbxr;
            that.mobile = res.billdata.mobile;
            that.pk_org = res.billdata.pk_org;
            that.fkyhzh = res.billdata.fkyhzh;
            ...
            that.project_name = res.billdata.project_name;
            that.hbbm = res.billdata.hbbm;
            that.deptid = res.billdata.deptid;
            that.paytarget = res.billdata.paytarget;
            that.custaccount = res.billdata.custaccount;
            that.zyx5 = res.billdata.zyx5;
            that.writeoffList= res.billdata.publicbussub.writeoffvoList;
            that.itemvoList = res.billdata.publicbussub.itemVOList;
            that.hotelList = res.billdata.publicbussub.hotelList;
            that.travelList = res.billdata.publicbussub.travelList;
            that._imgURL = res.billdata.publicbussub.imgURL;
            that._attachmentList = res.billdata.publicbussub.attachmentList;
            if(that._attachmentList === null || that._attachmentList.length === 0){
              that.fuCount = 0;
            }else{
              that.fuCount = that._attachmentList.length;
            }
          }else {
            Toast("获取失败,"+res.msg);
          }
