<template>
  ...
  <div style="overflow: hidden">
    ...
    <div class="panel"  >
      ...
      <div class="panelBody"  v-for="(item,index5) in writeoffvoList" v-show="'show'+index$4 === isOpen4">
        <ul class="entering">
          <li class="entering-itemsub" >
            <div class="entering-left">
    ...
    methods:{
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          Indicator.close();
          if (res.flag === "success"){
            that.costClassData = res.billdata;
            if(that.costClassData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            ...
            that.writeoffvoList= res.billdata.costclasssub.writeoffvoList;
            that.itemvoList = res.billdata.costclasssub.itemVOList;
            that._attachmentList = res.billdata.costclasssub.attachmentList;
            that._imgURL = res.billdata.costclasssub.imgURL;
