<template>
  ...
  <div style="overflow: hidden">
    ...
    <ul class="entering">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">支付对象：</span>
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">备注：</span>
          <span class="entering-input">{{zyx29}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">事由：</span>
          <span class="entering-input">{{zyx19}}</span>
        </div>
      </li>
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">产业类别：</span>
          <span class="entering-input">{{jobid}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item">
        <div class="entering-left">
          ...
          <span class="entering-input">{{bankcode}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">供应商银行账户：</span>
          <span class="entering-input">{{custacccount}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">产业类别:</span>
              <span class="entering-input">{{item.defitem20}}</span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="panelBody"  v-for="(item,index5) in writeoffList" v-show="'show'+index$4 === isOpen4">
        <ul class="entering">
          ...
          <li class="entering-itemsub" @click="selectStage">
            <div class="entering-left">
              <span class="entering-title">申请人:</span>
              <span class="entering-input">{{item.jkbxr}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
              <span class="entering-title">申请部门:</span>
              <span class="entering-input">{{item.deptid}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">申请金额:</span>
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">申请日期:</span>
...
<script type="text/ecmascript-6">
  import {Toast,Indicator,Field,Actionsheet} from 'mint-ui'
  ...
  export default {
    ...
    created(){
      ...
      console.log(this.billtypeparam);
      console.log(this.billidparam);
      console.log(this.checkmanparam);
      console.log(this.pk_flowparam);
      console.log(this.mobilebilltypeparam);
      console.log(this.workflowtypeparam);
    ...
    methods:{
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          Indicator.close();
          if (res.flag === "success"){
            that.benefitData = res.billdata;
            if(that.benefitData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            ...
            that.zyx29 = res.billdata.zyx29;
            that.paytarget = res.billdata.paytarget;
            that.fydwbm = res.billdata.fydwbm;
            that.zyx19 = res.billdata.zyx19;
            that.jobid = res.billdata.jobid;
            that.deptid = res.billdata.deptid;
            that.pk_payorg = res.billdata.pk_payorg;
            that.hbbm = res.billdata.hbbm;
            that.bankcode = res.billdata.bankcode;
            that.jsfs = res.billdata.jsfs;
            that.fkyhzh = res.billdata.fkyhzh;
            that.custacccount = res.billdata.custacccount;
            that.djbh = res.billdata.djbh;
            that.mobile = res.billdata.mobile;
            that.writeoffList= res.billdata.benefitsub.writeoffvoList;
            that.itemvoList = res.billdata.benefitsub.itemVOList;
            that._imgURL = res.billdata.benefitsub.imgURL;
            that._attachmentList = res.billdata.benefitsub.attachmentList;
      ...
      getfilelist(){
        ...
        getfilelist(params).then(res=>{
          Indicator.close();
          if (res.flag === "success"){
            that.attachmentList= res.billdata.benefitsub;
