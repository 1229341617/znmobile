  ...
  <div style="overflow: hidden">
    ...
    <ul class="entering">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          ...
          <span class="entering-input">{{vat_amount}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
    ...
    <div class="panel"  >
      <div class="panelTitle" @click="openProject1(index$1)">
        <div class="titleLeft">发票信息</div>
        <div class="titleRight">
          <img src="./image/icon_close.svg" v-show="'show'+index$1 === isOpen1"/>
          <img src="./image/icon_open.svg" v-show="'show'+index$1 != isOpen1"/>
        </div>
      </div>
      <div class="panelBody" v-for="(item,index2) in invoiceItemList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">入账金额:</span>
    ...
    methods:{
     ...
     showSheetVisible(){
      ...
      openProject1(index) {
        ...
        if(!this.invoiceItemList[0]&&this.isOpen1!="hidden"){
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{http://172.10.13.24:8200
          Indicator.close();
          if (res.flag === "success"){
            that.invoiceEnterData = res.billdata;
            if(that.invoiceEnterData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            ...
            that.vat_amount = res.billdata.vat_amount;
            ...
            that.invoiceItemList = res.billdata.invoiceItemList;
            that._imgURL = res.billdata.imgURL;
            that._attachmentList = res.billdata.attachmentList;
