<template>
  ...
  <div style="overflow: hidden">
    ...
    <ul class="entering">
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">支付方式：</span>
    ...
    <div class="panel"  >
      <div class="panelTitle" @click="openProject1(index$1)">
        <div class="titleLeft">招待费明细（页签一）</div>
        <div class="titleRight">
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">招待日期:</span>
          ...
          <li class="entering-itemsub">
            <div class="entering-left">
              <span class="entering-title">招待对象:</span>
              <span class="entering-input">{{item.defitem6}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">客人人数:</span>
              <span class="entering-input">{{item.defitem7}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">陪同人数:</span>
              <span class="entering-input">{{item.defitem8}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">物业收入类型:</span>
              <span class="entering-input">{{item.defitem21}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">项目:</span>
              <span class="entering-input">{{item.project_name}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
    ...
    <div class="panel">
      ...
      <div class="panelBody"  v-for="(item,index5) in writeoffList" v-show="'show'+index$4 === isOpen4">
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">冲销原币金额:</span>
    ...
    methods:{
     ...
     approvehistoryinfo() {
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{http://172.10.13.24:8200
          Indicator.close();
          if (res.flag === "success"){
            ...
            that.writeoffList= res.billdata.servesub.writeoffvoList;
            that.itemvoList = res.billdata.servesub.itemVOList;
            that._imgURL = res.billdata.servesub.imgURL;
            that._attachmentList = res.billdata.servesub.attachmentList;
