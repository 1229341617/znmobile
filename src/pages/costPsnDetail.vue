<template>
  ...
  <div style="overflow: hidden">
    <!--协同详情、返回-->
    <mt-header class="my-header" title="协同详情" style="width:100%;position:fixed;left:0;z-index:999;top:0;">
    ...
    <div class="panel"  >
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          ...
          <li class="entering-itemsub">
            <div class="entering-left">
              <span class="entering-title">费用总额:</span>
              <span class="entering-input">{{item.defitem16}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">已报销金额:</span>
              <span class="entering-input">{{item.defitem17}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">剩余可报销金额:</span>
              <span class="entering-input">{{item.defitem18}}</span>
            </div>
          </li>
          <li class="entering-itemsub">
            <div class="entering-left">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              ...
              <span class="entering-input">{{item.jobid}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
        ...
        <ul class="entering">
          ...
          <li class="entering-itemsub" >
            <div class="entering-left">
              ...
              <span class="entering-input">{{item.bbje}}</span>
            </div>
          </li>
          <li class="entering-itemsub" >
            <div class="entering-left">
     ...
     showSheetVisible(){
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          ...
          if (res.flag === "success"){
           console.log(res);
            that.costPsnData = res.billdata;
            if(that.costPsnData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            ...
            that.writeoffList= res.billdata.costpsnsub.writeoffvoList;
            that.itemvoList = res.billdata.costpsnsub.itemVOList;
            that._attachmentList = res.billdata.costpsnsub.attachmentList;
            that._imgURL = res.billdata.costpsnsub.imgURL;
