  ...
  <div style="overflow: hidden">
    ...
    <div class="title_header">
      <ul class="belowheader">
        ...
        <li class="belowheader-item">
          <div class="belowheader-left">
            <span class="belowheader-title" style="font-size:14px;">{{billmaker}}</span>
            <span class="belowheader-input" style="font-size:14px;">{{billdate}}</span>
          </div>
        </li>
      </ul>
    </div>
    ...
    <ul class="entering">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          ...
          <span class="entering-input">{{billno}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">单据日期：</span>
          <span class="entering-input">{{billdate}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">申请人：</span>
          <span class="entering-input">{{billmaker}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">申请单位：</span>
          <span class="entering-input">{{apply_org}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">申请部门：</span>
          <span class="entering-input">{{apply_dept}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">申请金额：</span>
          <span class="entering-input">{{amount}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">手机：</span>
          <span class="entering-input">{{defitem2}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">充值卡号：</span>
          <span class="entering-input">{{defitem3}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">单据录入说明：</span>
          <span class="entering-input">{{defitem29}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">事由：</span>
          <span class="entering-input">{{defitem30}}</span>
        </div>
      </li>
    </ul>
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          <li class="entering-itemsub" >
            <div class="entering-left">
              <span class="entering-title">充值金额:</span>
    ...
    methods:{
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          Indicator.close();
          if (res.flag === "success"){
            that.oilcardData = res.billdata;
            if(that.oilcardData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            that.billno = res.billdata.billno;
            that.billdate = res.billdata.billdate;
            that.billmaker = res.billdata.billmaker;
            that.apply_org = res.billdata.apply_org;
            that.apply_dept = res.billdata.apply_dept;
            that.amount = res.billdata.amount;
            that.defitem2 = res.billdata.defitem2;
            that.defitem3 = res.billdata.defitem3;
            that.defitem29 = res.billdata.defitem29;
            that.defitem30 = res.billdata.defitem30;
            that.itemvoList = res.billdata.oilcardsub.itemVOList;
            that._imgURL = res.billdata.oilcardsub.imgURL;
            that._attachmentList = res.billdata.oilcardsub.attachmentList;
