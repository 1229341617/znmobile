    ...
    <ul class="entering">
      <!--<li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">交易类型</span>
          <span class="entering-input">{{pk_billtypeid}}</span>
        </div>
      </li>-->
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">借款金额：</span>
      ...
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">借款单位：</span>
          <span class="entering-input">{{pk_org}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
          <span class="entering-title">借款人岗位：</span>
          <span class="entering-input">{{zyx1}}</span>
        </div>
      </li>
      <li class="entering-item">
        <div class="entering-left">
      ...
      <li class="entering-item" >
        <div class="entering-left">
          <span class="entering-title">借款人部门：</span>
      ...
      <div class="panelBody" v-for="(item,index2) in itemvoList" v-show="'show'+index$1 === isOpen1">
        <ul class="entering">
          ...
          <li class="entering-itemsub">
            <div class="entering-left">
              <span class="entering-title">借款金额:</span>
              <span class="entering-input">{{item.amount}}</span>
            </div>
          </li>
        </ul>
      </div>
    ...
    methods:{
      ...
      initIteminfo(){
        ...
        getBillDetail(params).then(res=>{
          Indicator.close();
          if (res.flag === "success"){
            that.borpubData = res.billdata;
            if(that.borpubData.length === 0){
              Toast("没有待审批数据");
              return;
            }
            that.pk_billtypeid = res.billdata.pk_billtypeid;
            ...
            that.pk_cashaccount = res.billdata.pk_cashaccount;
            ...
            that.itemvoList = res.billdata.brrowPubsub.itemVOList;
            that._imgURL = res.billdata.brrowPubsub.imgURL;
            that._attachmentList = res.billdata.brrowPubsub.attachmentList;
            if(that._attachmentList.length === 0 || that._attachmentList === null){
              that.fuCount = 0;
            }else{
